...
class m140806_193126_fix extends CDbMigration
{
	...
	{
		$this->delete('{{config}}', 'param = :param', array('param' => 'captcha.bg.color'));
		$this->delete('{{config}}', 'param = :param', array('param' => 'captcha.font.color'));
		$this->delete('{{config}}', 'param = :param', array('param' => 'register.multiemail'));
	}
}