...
<div class="page-header">
    <h1><?php echo Yii::t('install', 'Шаг 6, создание админа') ?></h1>
</div>
...
<?php $form = $this->beginWidget('ActiveForm', array(
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            ...
            <p class="help-block"><?php echo Yii::t('install', 'Длина логина от :min до :max символов', array(':min' => Users::LOGIN_MIN_LENGTH, ':max' => Users::LOGIN_MAX_LENGTH)) ?></p>
        </div>
    </div>
    <div class="form-group">
